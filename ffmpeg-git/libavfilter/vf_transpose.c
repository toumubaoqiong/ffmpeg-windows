...
static int config_props_output(AVFilterLink *outlink)
{
    ...
    const AVPixFmtDescriptor *pixdesc = &(av_getav_pix_fmt_descriptors())[outlink->format];

    trans->hsub = (av_getav_pix_fmt_descriptors())[inlink->format].log2_chroma_w;
    trans->vsub = (av_getav_pix_fmt_descriptors())[inlink->format].log2_chroma_h;
