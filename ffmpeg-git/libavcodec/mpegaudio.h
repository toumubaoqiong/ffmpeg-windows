...
FFMPEGLIB_API int ff_mpa_l2_select_table(int bitrate, int nb_channels, int freq, int lsf);
FFMPEGLIB_API int ff_mpa_decode_header(AVCodecContext *avctx, uint32_t head, int *sample_rate, int *channels, int *frame_size, int *bitrate);
