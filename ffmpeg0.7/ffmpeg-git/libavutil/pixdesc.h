 ...
 */
FFMPEGLIB_API enum PixelFormat av_get_pix_fmt(const char *name);
 ...
 */
FFMPEGLIB_API char *av_get_pix_fmt_string (char *buf, int buf_size, enum PixelFormat pix_fmt);
 ...
 * not counted.
 */
FFMPEGLIB_API int av_get_bits_per_pixel(const AVPixFmtDescriptor *pixdesc);
