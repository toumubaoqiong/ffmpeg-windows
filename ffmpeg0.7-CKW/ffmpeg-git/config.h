...
#define FFMPEG_CONFIGURATION "--enable-shared --disable-static --enable-gpl --enable-version3 --enable-runtime-cpudetect --enable-memalign-hack --target-os=mingw32 --enable-avisynth --enable-bzlib --enable-libopencore-amrnb --enable-libopencore-amrwb --enable-libmp3lame --enable-libspeex --enable-libvpx --enable-libx264 --enable-libxavs --enable-libxvid --extra-cflags=-I/usr/local/include --extra-ldflags=-L/usr/local/lib"
#define FFMPEG_LICENSE "GPL version 3 or later"
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define CC_TYPE "gcc"
#define CC_VERSION __VERSION__
//wangqq 2011-8-22 11:11:29
