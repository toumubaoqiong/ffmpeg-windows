 ...
 */
FFMPEGLIB_API unsigned swscale_version(void);

/**
 * Returns the libswscale build-time configuration.
 */
FFMPEGLIB_API const char *swscale_configuration(void);

/**
 * Returns the libswscale license.
 */
FFMPEGLIB_API const char *swscale_license(void);
 ...
 */
FFMPEGLIB_API const int *sws_getCoefficients(int colorspace);
...
FFMPEGLIB_API void sws_subVec(SwsVector *a, SwsVector *b);
FFMPEGLIB_API void sws_shiftVec(SwsVector *a, int shift);
