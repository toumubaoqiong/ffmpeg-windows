...
{
    if ((unsigned)format < PIX_FMT_NB && (av_getav_pix_fmt_descriptors())[format].name)
        return (av_getav_pix_fmt_descriptors())[format].name;
    else
...
{
    *h = (av_getav_pix_fmt_descriptors())[format].log2_chroma_w;
    *v = (av_getav_pix_fmt_descriptors())[format].log2_chroma_h;
}
...
int sws_setColorspaceDetails(SwsContext *c, const int inv_table[4], int srcRange, const int table[4], int dstRange, int brightness, int contrast, int saturation)
{
    ...
    c->dstFormatBpp = av_get_bits_per_pixel(&(av_getav_pix_fmt_descriptors())[c->dstFormat]);
...
int sws_init_context(SwsContext *c, SwsFilter *srcFilter, SwsFilter *dstFilter)
{
    ...
    c->dstFormatBpp = av_get_bits_per_pixel(&(av_getav_pix_fmt_descriptors())[dstFormat]);
    c->srcFormatBpp = av_get_bits_per_pixel(&(av_getav_pix_fmt_descriptors())[srcFormat]);
