 ...
 *         the tree.
 */
FFMPEGLIB_API void *av_tree_find(const struct AVTreeNode *root, void *key, int (*cmp)(void *key, const void *b), void *next[2]);
 ...
 */
FFMPEGLIB_API void *av_tree_insert(struct AVTreeNode **rootp, void *key, int (*cmp)(void *key, const void *b), struct AVTreeNode **next);
FFMPEGLIB_API void av_tree_destroy(struct AVTreeNode *t);
 ...
 *       tree.
 */
FFMPEGLIB_API void av_tree_enumerate(struct AVTreeNode *t, void *opaque, int (*cmp)(void *opaque, void *elem), int (*enu)(void *opaque, void *elem));
