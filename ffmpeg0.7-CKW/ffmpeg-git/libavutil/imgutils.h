 ...
 */
FFMPEGLIB_API int av_image_get_linesize(enum PixelFormat pix_fmt, int width, int plane);
 ...
 */
FFMPEGLIB_API int av_image_fill_linesizes(int linesizes[4], enum PixelFormat pix_fmt, int width);
 ...
 */
FFMPEGLIB_API int av_image_check_size(unsigned int w, unsigned int h, int log_offset, void *log_ctx);

FFMPEGLIB_API int ff_set_systematic_pal2(uint32_t pal[256], enum PixelFormat pix_fmt);
...
attribute_deprecated
FFMPEGLIB_API int av_fill_image_linesizes(int linesizes[4], enum PixelFormat pix_fmt, int width);
