...
//****************************************************************************//
//libavutil\eval.h, libavutil\eval.c
//	解析字符串计算式并计算字符串计算式的值
//学习的地方：
//1.这是一个疑问，以后弄清楚。
//2.这样的字符表达式的设计，以前我做过，但是和现在的不一样，我的是二进制的，
//所以有些地方不同，需要思考
//附录：
//****************************************************************************//
 ...
 */
FFMPEGLIB_API double av_expr_eval(AVExpr *e, const double *const_values, void *opaque);

/**
 * Free a parsed expression previously created with av_expr_parse().
 */
FFMPEGLIB_API void av_expr_free(AVExpr *e);
 ...
 */
attribute_deprecated
FFMPEGLIB_API double av_eval_expr(AVExpr *e, const double *const_values, void *opaque);

/**
 * @deprecated Deprecated in favor of av_expr_free().
 */
attribute_deprecated
FFMPEGLIB_API void av_free_expr(AVExpr *e);
 ...
 */
FFMPEGLIB_API double av_strtod(const char *numstr, char **tail);
