 ...
 */
#ifdef __GNUC__
FFMPEGLIB_API void av_log(void *avcl, int level, const char *fmt, ...) __attribute__ ((__format__ (__printf__, 3, 4)));
#else
FFMPEGLIB_API void av_log(void *avcl, int level, const char *fmt, ...);
#endif
