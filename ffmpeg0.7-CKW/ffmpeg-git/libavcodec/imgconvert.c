...
{
    *h_shift = (av_getav_pix_fmt_descriptors())[pix_fmt].log2_chroma_w;
    *v_shift = (av_getav_pix_fmt_descriptors())[pix_fmt].log2_chroma_h;
}
...
const char *avcodec_get_pix_fmt_name(enum PixelFormat pix_fmt)
{
    if ((unsigned)pix_fmt >= PIX_FMT_NB)
        ...
        return (av_getav_pix_fmt_descriptors())[pix_fmt].name;
}
...
{
    return (av_getav_pix_fmt_descriptors())[pix_fmt].flags & PIX_FMT_HWACCEL;
}
                             ...
                             int has_alpha)
{
    ...
    const AVPixFmtDescriptor *src_desc = &(av_getav_pix_fmt_descriptors())[src_pix_fmt];
    const AVPixFmtDescriptor *dst_desc = &(av_getav_pix_fmt_descriptors())[dst_pix_fmt];
    int loss;
                    ...
                    enum PixelFormat pix_fmt, int top_band, int left_band)
{
    ...
    y_shift = (av_getav_pix_fmt_descriptors())[pix_fmt].log2_chroma_h;
    x_shift = (av_getav_pix_fmt_descriptors())[pix_fmt].log2_chroma_w;
                   ...
                   int *color)
{
    ...
    for (i = 0; i < 3; i++)
    {
        x_shift = i ? (av_getav_pix_fmt_descriptors())[pix_fmt].log2_chroma_w : 0;
        y_shift = i ? (av_getav_pix_fmt_descriptors())[pix_fmt].log2_chroma_h : 0;
