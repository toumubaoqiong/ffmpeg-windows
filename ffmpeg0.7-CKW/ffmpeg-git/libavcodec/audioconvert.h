 ...
 */
FFMPEGLIB_API int64_t avcodec_guess_channel_layout(int nb_channels, enum CodecID codec_id, const char *fmt_name);
 ...
 */
FFMPEGLIB_API void av_audio_convert_free(AVAudioConvert *ctx);
