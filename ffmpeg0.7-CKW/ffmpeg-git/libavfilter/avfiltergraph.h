 ...
 */
FFMPEGLIB_API AVFilterGraph *avfilter_graph_alloc(void);
 ...
 * cannot be found.
 */
FFMPEGLIB_API AVFilterContext *avfilter_graph_get_filter(AVFilterGraph *graph, char *name);
 ...
 */
FFMPEGLIB_API int avfilter_graph_add_filter(AVFilterGraph *graphctx, AVFilterContext *filter);
 ...
 */
FFMPEGLIB_API int avfilter_graph_config(AVFilterGraph *graphctx, AVClass *log_ctx);

/**
 * Free a graph, destroy its links, and set *graph to NULL.
 * If *graph is NULL, do nothing.
 */
FFMPEGLIB_API void avfilter_graph_free(AVFilterGraph **graph);
