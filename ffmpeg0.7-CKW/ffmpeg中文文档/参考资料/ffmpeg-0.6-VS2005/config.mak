...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-muxers --disable-encoders --disable-asm --disable-devices --disable-protocol=rtmp --disable-protocol=rtmpe --disable-protocol=rtmps --disable-protocol=rtmpt --disable-protocol=rtmpte --disable-filters
prefix=/usr/local
...
SRC_PATH="/home/ffmpeg-0.6.intel"
SRC_PATH_BARE=/home/ffmpeg-0.6.intel
BUILD_ROOT="/home/ffmpeg-0.6.intel"
ARCH=c
CC=gcc
AS=gcc
LD=gcc
...
CFLAGS=   -std=c99 -fomit-frame-pointer -g -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wundef -Wmissing-prototypes -O3 -fno-math-errno -fno-tree-vectorize
ASFLAGS=   -g
CC_O=-o $@
