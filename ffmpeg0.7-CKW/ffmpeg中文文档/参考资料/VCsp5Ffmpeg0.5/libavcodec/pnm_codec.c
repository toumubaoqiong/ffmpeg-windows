...
enum PixelFormat pix_fmts0[] = {PIX_FMT_GRAY8, -1};
...
enum PixelFormat pix_fmts1[]={PIX_FMT_YUV420P, -1};
...
enum PixelFormat pix_fmts3[] = {PIX_FMT_RGB24, -1};
...
enum PixelFormat pix_fmts4[] = {PIX_FMT_MONOWHITE, -1};
...
enum PixelFormat pix_fmts5[] = {PIX_FMT_RGB24, PIX_FMT_RGBA32, PIX_FMT_GRAY8, PIX_FMT_MONOWHITE, -1};
