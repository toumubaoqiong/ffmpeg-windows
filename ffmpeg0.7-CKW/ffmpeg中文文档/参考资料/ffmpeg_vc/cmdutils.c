...
AVCodecContext *avctx_opts[CODEC_TYPE_NB] = {NULL};
AVFormatContext *avformat_opts = NULL;
struct SwsContext *sws_opts = NULL;
...
unknown_opt:
            ...
            if (po->flags & OPT_STRING) {
                ...
                *po->u.float_arg = parse_number_or_die(opt+1, arg, OPT_FLOAT, /*-1.0/0.0, 1.0/0.0*/INT32_MIN, INT32_MAX);
