...
#pragma pack(8)
	...
	uint64_t *aligned_bak = (uint64_t *)malloc(stride * sizeof(uint64_t));
#pragma pack(pop)
...
#if 0//def CONFIG_CAVS_DECODER
    ff_cavsdsp_init(c,avctx);
#endif
#if 1//defined(CONFIG_VC1_DECODER) || defined(CONFIG_WMV3_DECODER)
    ff_vc1dsp_init(c,avctx);
#endif
#if 1//defined(CONFIG_WMV2_DECODER) || defined(CONFIG_VC1_DECODER) || defined(CONFIG_WMV3_DECODER)
    ff_intrax8dsp_init(c,avctx);
#endif
#if defined(CONFIG_H264_ENCODER)
    ff_h264dspenc_init(c,avctx);
#endif
#if 1//defined(CONFIG_RV40_DECODER)
...
//    if (/*ENABLE_VP3_DECODER || ENABLE_THEORA_DECODER*/0) {
...
#if 1//def CONFIG_VORBIS_DECODER
    c->vorbis_inverse_coupling = vorbis_inverse_coupling;
#endif
#if 1//def CONFIG_AC3_DECODER
    c->ac3_downmix = ff_ac3_downmix_c;
#endif
#if 0//def CONFIG_FLAC_ENCODER
