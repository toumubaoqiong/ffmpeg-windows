                            ...
                            const uint8_t *buf, int buf_size)
{
    ...
    *data_size=0;
    ...
    case CODEC_ID_PCM_U8:
        ...
        src += n*sample_size;
        samples = (unsigned short*)((uint8_t*)data + n*sample_size);
        break;
    case CODEC_ID_PCM_ZORK:
        for(;n>0;n--) {
            int x= *src++;
...
enum SampleFormat SAMPLE_FMT_U8_ARRAY[2] = {SAMPLE_FMT_U8, SAMPLE_FMT_NONE};
enum SampleFormat SAMPLE_FMT_S16_ARRAY[2] = {SAMPLE_FMT_S16, SAMPLE_FMT_NONE};
enum SampleFormat SAMPLE_FMT_S32_ARRAY[2] = {SAMPLE_FMT_S32, SAMPLE_FMT_NONE};
enum SampleFormat SAMPLE_FMT_FLT_ARRAY[2] = {SAMPLE_FMT_FLT, SAMPLE_FMT_NONE};
enum SampleFormat SAMPLE_FMT_DBL_ARRAY[2] = {SAMPLE_FMT_DBL, SAMPLE_FMT_NONE};
...
AVCodec name ## _encoder = {                    \
    ...
    NULL,                                       \
	&sample_fmt_##_ARRAY,/*.sample_fmts = (enum SampleFormat[]){sample_fmt_,SAMPLE_FMT_NONE}, */\
};
#else
#define PCM_ENCODER(id,sample_fmt_,name,long_name_)
#endif
...
PCM_DECODER  (CODEC_ID_PCM_S8,    SAMPLE_FMT_U8,  pcm_s8, "signed 8-bit PCM");
...
PCM_DECODER  (CODEC_ID_PCM_U8,    SAMPLE_FMT_U8,  pcm_u8, "unsigned 8-bit PCM");
...
#endif
//AVCodec pcm_s16le_planar
#if 0
AVCodec pcm_mulaw_decoder = {                    
    "pcm_s16le_planar",                                      
    CODEC_TYPE_AUDIO,                           
    CODEC_ID_PCM_S16LE,                                         
    sizeof(PCMDecode),                          
	...
	NULL,                                       
	NULL,                                       
	/*.long_name = */NULL_IF_CONFIG_SMALL("16-bit little-endian planar PCM"), 
    NULL,                                        
	&SAMPLE_FMT_S16_ARRAY,/*.sample_fmts = (enum SampleFormat[]){sample_fmt_,SAMPLE_FMT_NONE}, */
};
#endif