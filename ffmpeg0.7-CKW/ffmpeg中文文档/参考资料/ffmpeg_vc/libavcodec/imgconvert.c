...
static const PixFmtInfo pix_fmt_info[PIX_FMT_NB] = {
   ...
   /*[PIX_FMT_YUVJ420P] = */{
    ...
    /*[PIX_FMT_RGB32] = */{
        ...
        /*.pixel_type = */FF_PIXEL_PACKED,
        /*.depth = */8,
        /*.x_chroma_shift = */0, /*.y_chroma_shift = */0, 1
    },
    /*[PIX_FMT_RGB565] = */{
        /*.name = */"rgb565",
        /*.nb_channels = */3,
...
static const ConvertEntry convert_table[PIX_FMT_NB][PIX_FMT_NB] = {
    /*[PIX_FMT_YUV420P] = */{
        ...
        /*[PIX_FMT_RGB555] = */{
            /*.convert = */yuv420p_to_yuyv422//yuv420p_to_rgb555
        },
        /*[PIX_FMT_RGB565] = */{
            /*.convert = */yuv420p_to_yuyv422//yuv420p_to_rgb565
        },
        /*[PIX_FMT_BGR24] = */{
            /*.convert = */yuv420p_to_yuyv422//yuv420p_to_bgr24
        },
        /*[PIX_FMT_RGB24] = */{
            /*.convert = */yuv420p_to_yuyv422//yuv420p_to_rgb24
        },
        /*[PIX_FMT_RGB32] = */{
            /*.convert = */yuv420p_to_yuyv422//yuv420p_to_rgb32
        },
        /*[PIX_FMT_UYVY422] = */{
    ...
    /*[PIX_FMT_YUV444P] = */{
       /* [PIX_FMT_RGB24] = */{
	   /* .convert = */NULL//yuv444p_to_rgb24
        },
    },
    /*[PIX_FMT_YUVJ420P] = */{
        /*[PIX_FMT_RGB555] = */{
            /*.convert = */NULL//yuvj420p_to_rgb555
        },
        /*[PIX_FMT_RGB565] = */{
            /*.convert = */NULL//yuvj420p_to_rgb565
        },
        /*[PIX_FMT_BGR24] = */{
            /*.convert = */NULL//yuvj420p_to_bgr24
        },
        /*[PIX_FMT_RGB24] = */{
           /* .convert = */NULL//yuvj420p_to_rgb24
        },
       /* [PIX_FMT_RGB32] = */{
            /*.convert = */NULL//yuvj420p_to_rgb32
        },
    },
    /*[PIX_FMT_YUVJ444P] = */{
        /*[PIX_FMT_RGB24] = */{
            /*.convert = */NULL//yuvj444p_to_rgb24
        },
    },
    /*[PIX_FMT_YUYV422] = */{
        /*[PIX_FMT_YUV420P] = */{
   ...
   /* [PIX_FMT_RGB24] = */{
        /*[PIX_FMT_YUV420P] =*/ {
            /*.convert = */NULL//rgb24_to_yuv420p
        },
        /*[PIX_FMT_RGB565] = */{
            /*.convert = */NULL//rgb24_to_rgb565
        },
        /*[PIX_FMT_RGB555] =*/{
            /*.convert = */NULL//rgb24_to_rgb555
        },
        /*[PIX_FMT_RGB32] = */{
            /*.convert = */NULL//rgb24_to_rgb32
        },
        /*[PIX_FMT_BGR24] = */{
            /*.convert =*/ NULL//rgb24_to_bgr24
        },
        /*[PIX_FMT_GRAY8] = */{
           /* .convert = */NULL//rgb24_to_gray
        },
        /*[PIX_FMT_PAL8] = */{
            /*.convert = */NULL//rgb24_to_pal8
        },
        /*[PIX_FMT_YUV444P] = */{
            /*.convert = */NULL//rgb24_to_yuv444p
        },
        /*[PIX_FMT_YUVJ420P] = */{
            /*.convert = */NULL//rgb24_to_yuvj420p
        },
        /*[PIX_FMT_YUVJ444P] =*/ {
            /*.convert = */NULL//rgb24_to_yuvj444p
        },
    },
    /*[PIX_FMT_RGB32] = */{
        /*[PIX_FMT_RGB24] = */{
            /*.convert = */NULL//rgb32_to_rgb24
        },
        /*[PIX_FMT_BGR24] =*/ {
            /*.convert = */NULL//rgb32_to_bgr24
        },
        /*[PIX_FMT_RGB565] = */{
            /*.convert = */NULL//rgb32_to_rgb565
        },
        /*[PIX_FMT_RGB555] = */{
           /* .convert = */NULL//rgb32_to_rgb555
        },
        /*[PIX_FMT_PAL8] = */{
            /*.convert = */NULL//rgb32_to_pal8
        },
        /*[PIX_FMT_YUV420P] = */{
            /*.convert = */NULL//rgb32_to_yuv420p
        },
        /*[PIX_FMT_GRAY8] = */{
            /*.convert = */NULL//rgb32_to_gray
        },
    },
    /*[PIX_FMT_BGR24] = */{
        /*[PIX_FMT_RGB32] = */{
            /*.convert = */NULL//bgr24_to_rgb32
        },
        /*[PIX_FMT_RGB24] = */{
            /*.convert = */NULL//bgr24_to_rgb24
        },
        /*[PIX_FMT_YUV420P] = */{
            /*.convert = */NULL//bgr24_to_yuv420p
        },
        /*[PIX_FMT_GRAY8] = */{
            /*.convert = */NULL//bgr24_to_gray
        },
    },
    /*[PIX_FMT_RGB555] = */{
        /*[PIX_FMT_RGB24] = */{
            /*.convert = */NULL//rgb555_to_rgb24
        },
        /*[PIX_FMT_RGB32] =*/{
            /*.convert = */NULL//rgb555_to_rgb32
        },
        /*[PIX_FMT_YUV420P] = */{
            /*.convert = */NULL//rgb555_to_yuv420p
        },
        /*[PIX_FMT_GRAY8] = */{
            /*.convert = v*/NULL//rgb555_to_gray
        },
    },
    /*[PIX_FMT_RGB565] = */{
        /*[PIX_FMT_RGB32] = */{
            /*.convert = */NULL//rgb565_to_rgb32
        },
        /*[PIX_FMT_RGB24] = */{
            /*.convert = */NULL//rgb565_to_rgb24
        },
        /*[PIX_FMT_YUV420P] =*/ {
            /*.convert = */NULL//rgb565_to_yuv420p
        },
        /*[PIX_FMT_GRAY8] =*/ {
            /*.convert =*/ NULL//rgb565_to_gray
        },
    },
    /*[PIX_FMT_GRAY16BE] =*/ {
        /*[PIX_FMT_GRAY8] =*/ {
    ...
    /*[PIX_FMT_GRAY8] =*/ {
       /* [PIX_FMT_RGB555] = */{
            /*.convert = */NULL//gray_to_rgb555
        },
        /*[PIX_FMT_RGB565] =*/ {
            /*.convert = */NULL//gray_to_rgb565
        },
        /*[PIX_FMT_RGB24] = */{
            /*.convert = */NULL//gray_to_rgb24
        },
        /*[PIX_FMT_BGR24] =*/ {
            /*.convert = */NULL//gray_to_bgr24
        },
        /*[PIX_FMT_RGB32] =*/ {
            /*.convert = */NULL//gray_to_rgb32
        },
       /* [PIX_FMT_MONOWHITE] = */{
    ...
    /*[PIX_FMT_PAL8] = */{
        /*[PIX_FMT_RGB555] =*/ {
            /*.convert = */NULL//pal8_to_rgb555
        },
        /*[PIX_FMT_RGB565] =*/ {
            /*.convert = */NULL//pal8_to_rgb565
        },
       /* [PIX_FMT_BGR24] = */{
           /* .convert = */NULL//pal8_to_bgr24
        },
        /*[PIX_FMT_RGB24] =*/ {
            /*.convert = */NULL//pal8_to_rgb24
        },
        /*[PIX_FMT_RGB32] =*/ {
            /*.convert = */NULL//pal8_to_rgb32
        },
    },
   /* [PIX_FMT_UYYVYY411] = */{
        /*[PIX_FMT_YUV411P] = */{
