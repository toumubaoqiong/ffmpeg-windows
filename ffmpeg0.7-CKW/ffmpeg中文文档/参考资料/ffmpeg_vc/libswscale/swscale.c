...
DECLARE_ASM_CONST(8, uint64_t, bF8)=       (uint64_t)0xF8F8F8F8F8F8F8F8L;
DECLARE_ASM_CONST(8, uint64_t, bFC)=       (uint64_t)0xFCFCFCFCFCFCFCFCL;
DECLARE_ASM_CONST(8, uint64_t, w10)=       (uint64_t)0x0010001000100010L;
DECLARE_ASM_CONST(8, uint64_t, w02)=       (uint64_t)0x0002000200020002L;
DECLARE_ASM_CONST(8, uint64_t, bm00001111)=(uint64_t)0x00000000FFFFFFFFL;
DECLARE_ASM_CONST(8, uint64_t, bm00000111)=(uint64_t)0x0000000000FFFFFFL;
DECLARE_ASM_CONST(8, uint64_t, bm11111000)=(uint64_t)0xFFFFFFFFFF000000L;
DECLARE_ASM_CONST(8, uint64_t, bm01010101)=(uint64_t)0x00FF00FF00FF00FFL;

const DECLARE_ALIGNED(8, uint64_t, ff_dither4[2]) = {
        (int64_t)0x0103010301030103L,
        (int64_t)0x0200020002000200L,};

const DECLARE_ALIGNED(8, uint64_t, ff_dither8[2]) = {
        (int64_t)0x0602060206020602L,
        (int64_t)0x0004000400040004L,};

DECLARE_ASM_CONST(8, uint64_t, b16Mask)=   (int64_t)0x001F001F001F001FL;
DECLARE_ASM_CONST(8, uint64_t, g16Mask)=   (int64_t)0x07E007E007E007E0L;
DECLARE_ASM_CONST(8, uint64_t, r16Mask)=   (int64_t)0xF800F800F800F800L;
DECLARE_ASM_CONST(8, uint64_t, b15Mask)=   (int64_t)0x001F001F001F001FL;
DECLARE_ASM_CONST(8, uint64_t, g15Mask)=   (int64_t)0x03E003E003E003E0L;
DECLARE_ASM_CONST(8, uint64_t, r15Mask)=   (int64_t)0x7C007C007C007C00L;

DECLARE_ALIGNED(8, const uint64_t, ff_M24A)         = (int64_t)0x00FF0000FF0000FFL;
DECLARE_ALIGNED(8, const uint64_t, ff_M24B)         = (int64_t)0xFF0000FF0000FF00L;
DECLARE_ALIGNED(8, const uint64_t, ff_M24C)         = (int64_t)0x0000FF0000FF0000L;

#ifdef FAST_BGR2YV12
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2YCoeff)   = (uint64_t)0x000000210041000DUL;
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2UCoeff)   = (uint64_t)0x0000FFEEFFDC0038UL;
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2VCoeff)   = (uint64_t)0x00000038FFD2FFF8UL;
#else
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2YCoeff)   = (uint64_t)0x000020E540830C8BUL;
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2UCoeff)   = (uint64_t)0x0000ED0FDAC23831UL;
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2VCoeff)   = (uint64_t)0x00003831D0E6F6EAUL;
#endif /* FAST_BGR2YV12 */
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2YOffset)  = (uint64_t)0x1010101010101010UL;
DECLARE_ALIGNED(8, const uint64_t, ff_bgr2UVOffset) = (uint64_t)0x8080808080808080UL;
DECLARE_ALIGNED(8, const uint64_t, ff_w1111)        = (uint64_t)0x0001000100010001UL;

DECLARE_ASM_CONST(8, uint64_t, ff_bgr24toY1Coeff) = (uint64_t)0x0C88000040870C88UL;
DECLARE_ASM_CONST(8, uint64_t, ff_bgr24toY2Coeff) = (uint64_t)0x20DE4087000020DEUL;
DECLARE_ASM_CONST(8, uint64_t, ff_rgb24toY1Coeff) = (uint64_t)0x20DE0000408720DEUL;
DECLARE_ASM_CONST(8, uint64_t, ff_rgb24toY2Coeff) = (uint64_t)0x0C88408700000C88UL;
DECLARE_ASM_CONST(8, uint64_t, ff_bgr24toYOffset) = (uint64_t)0x0008400000084000UL;

DECLARE_ASM_CONST(8, uint64_t, ff_bgr24toUV[2][4]) = {
    {(uint64_t)0x38380000DAC83838UL, (uint64_t)0xECFFDAC80000ECFFUL, (uint64_t)0xF6E40000D0E3F6E4UL, (uint64_t)0x3838D0E300003838UL},
    {(uint64_t)0xECFF0000DAC8ECFFUL, (uint64_t)0x3838DAC800003838UL, (uint64_t)0x38380000D0E33838UL, (uint64_t)0xF6E4D0E30000F6E4UL},
};

DECLARE_ASM_CONST(8, uint64_t, ff_bgr24toUVOffset)= (uint64_t)0x0040400000404000UL;
                             ...
                             SwsVector *srcFilter, SwsVector *dstFilter, double param[2])
{
    ...
    const int64_t fone= (int64_t)1L<<54;
    int ret= -1;
#if 0//ARCH_X86
...
/*                else if (flags & SWS_X)
                ...
                {
                    int64_t d2= d - (1<<29);
                    if      (d2*xInc < -((uint64_t)1L<<(29+16))) coeff= 1.0 * (1L<<(30+16));
                    else if (d2*xInc <  ((uint64_t)1L<<(29+16))) coeff= -d2*xInc + (1L<<(29+16));
                    else coeff=0.0;
                    coeff *= fone>>(30+16);
                }
...
int sws_setColorspaceDetails(SwsContext *c, const int inv_table[4], int srcRange, const int table[4], int dstRange, int brightness, int contrast, int saturation){
    ...
    c->uOffset=   (uint64_t)0x0400040004000400L;
    c->vOffset=   (uint64_t)0x0400040004000400L;
    ...
    c->yCoeff=    roundToInt16(cy *8192) * (uint64_t)0x0001000100010001UL;
    c->vrCoeff=   roundToInt16(crv*8192) * (uint64_t)0x0001000100010001UL;
    c->ubCoeff=   roundToInt16(cbu*8192) * (uint64_t)0x0001000100010001UL;
    c->vgCoeff=   roundToInt16(cgv*8192) * (uint64_t)0x0001000100010001UL;
    c->ugCoeff=   roundToInt16(cgu*8192) * (uint64_t)0x0001000100010001UL;
    c->yOffset=   roundToInt16(oy *   8) * (uint64_t)0x0001000100010001UL;
    ...
    /*sws_*/yuv2rgb_c_init_tables(c, inv_table, srcRange, brightness, contrast, saturation);
    //FIXME factorize
...
SwsContext *sws_getContext(int srcW, int srcH, enum PixelFormat srcFormat, int dstW, int dstH, enum PixelFormat dstFormat, int flags,
    ...
    c->vRounder= 4* (uint64_t)0x0001000100010001UL;
