...
DECLARE_ASM_CONST(8, uint64_t, mmx_00ffw)   = (uint64_t)0x00ff00ff00ff00ffUL;
DECLARE_ASM_CONST(8, uint64_t, mmx_redmask) = (uint64_t)0xf8f8f8f8f8f8f8f8UL;
DECLARE_ASM_CONST(8, uint64_t, mmx_grnmask) = (uint64_t)0xfcfcfcfcfcfcfcfcUL;
...
#endif
#if 0//def CONFIG_MLIB
    {
        SwsFunc t= yuv2rgb_init_mlib(c);
        if (t) return t;
    }
#endif
#if 0//def HAVE_ALTIVEC
